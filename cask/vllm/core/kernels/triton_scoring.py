...
See the inline derivation notes in this module and in `cask.vllm.core.scoring`.
"""
...
def triattention_scoring_kernel(
    ...
    for off_idx in tl.static_range(num_offsets):
        ...
        # See the inline derivation notes in this module for the equivalence argument.
