...
from cask.evaluation.evaluate import evaluate
from cask.evaluation.utils import save_jsonl
from cask.evaluation.python_executor import PythonExecutor
from cask.evaluation.data_loader import load_data_vanilla
from cask.evaluation.parser import choice_answer_clean, parse_ground_truth, run_execute
...
def main(data_name, args):
    ...
    with open(
        out_file.replace(".jsonl", f"_{args.prompt_type}_metrics.json"), "w", encoding="utf-8"
    ) as f:
