...
If you want to use a local HorizonKV vLLM server as an OpenClaw-compatible provider, you can manually edit `~/.openclaw/openclaw.json`.
...
The provider key can stay `triattention` for compatibility, but the displayed model name should usually be `HorizonKV`.
