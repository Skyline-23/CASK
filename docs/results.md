# Historical TriAttention Reference Results

These tables are retained as upstream reference numbers for the original TriAttention paper. They are useful for baseline comparison and context, but they are not HorizonKV results.
