...
- [`fig6_mass_recovery_hexagon.png`](fig6_mass_recovery_hexagon.png) / [`fig6_mass_recovery_hexagon.pdf`](fig6_mass_recovery_hexagon.pdf): Figure 6. Hexagon mass recovery: core-preserved mass versus final representative mass.
- [`fig7_cluster_collapse_hexagon.png`](fig7_cluster_collapse_hexagon.png) / [`fig7_cluster_collapse_hexagon.pdf`](fig7_cluster_collapse_hexagon.pdf): Figure 7. Event-level mass decomposition showing healthy representative preservation versus boundary collapse.
